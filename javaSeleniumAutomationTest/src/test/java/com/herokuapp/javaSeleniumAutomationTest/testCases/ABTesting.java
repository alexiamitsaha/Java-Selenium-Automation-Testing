...
public class ABTesting extends BaseClass {
    ...
    public  void  aBTesting() throws InterruptedException {
        ...
        boolean isVariation1Displayed = at.getabTestingVariation1().isDisplayed();
        boolean isControlDisplayed = at.getAbTestControl().isDisplayed();

        if (true == isVariation1Displayed) {
            String header1 = at.getabTestingVariation1().getText();
            Assert.assertEquals(Data.AB_TEST_VARIATION1, header1);
        } else if (true == isControlDisplayed) {
            String header2 = at.getAbTestControl().getText();
